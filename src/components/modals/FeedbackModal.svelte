<script lang="ts">
  import { Bug, Lightbulb, Send, ChevronDown, Monitor } from 'lucide-svelte';
...
>
  ...
  <div>
    ...
    <input
      ...
      class="w-full px-3 py-2.5 bg-surface-base border border-white/10 rounded-lg text-white text-sm placeholder-white/30 focus:outline-none focus:border-purple-500"
    />
  </div>
    ...
    <div class="grid grid-cols-2 gap-3">
      <div>
        ...
        <Select
          ...
          value={category}
          onchange={(e) => { category = (e.target as HTMLSelectElement).value as FeedbackCategory; }}
        >
      ...
      <div>
        ...
        <Select
          ...
          value={severity}
          onchange={(e) => { severity = (e.target as HTMLSelectElement).value as Severity; }}
        >
  ...
  <div>
    ...
    <textarea
      ...
      rows={3}
      class="w-full px-3 py-2.5 bg-surface-base border border-white/10 rounded-lg text-white text-sm placeholder-white/30 resize-none focus:outline-none focus:border-purple-500"
    ></textarea>
  </div>
